...
export async function generateMetadata() {
  ...
  return {
    ...
    alternates: {
      canonical: `https://mohammedaydan.com/${locale}`,
      languages: {
...
export default async function Home() {
  ...
  return (
    <div className={`w-full ${isRtl ? "rtl" : "ltr"}`}>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-b from-primary to-primary/80 pb-16 pt-32 text-white">
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex gap-4">
              <Link href="https://github.com/MohammedAydan" target="_blank" rel="noopener noreferrer">
                <Button
                  variant="outline"
                  size="icon"
              ...
              <Link href="https://linkedin.com/in/mohamed-aydan" target="_blank" rel="noopener noreferrer">
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full border-white/20 bg-white/10 backdrop-blur hover:bg-white hover:text-primary"
              ...
              <Link href="mailto:mohammedaydan12@gmail.com">
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full border-white/20 bg-white/10 backdrop-blur hover:bg-white hover:text-primary"
            ...
            <div className="flex flex-col space-y-4">
              ...
              <Card className="group transition-all hover:shadow-sm">
                <CardContent className="flex items-center p-4">
                  ...
                  <Link href="mailto:mohammedaydan12@gmail.com" className="flex flex-1 items-center justify-between">
                    <span>mohammedaydan12@gmail.com</span>
                    <ExternalLink className="h-4 w-4 opacity-0 transition-opacity group-hover:opacity-100" />
                  </Link>
                </CardContent>
              ...
              <Card className="group transition-all hover:shadow-sm">
                <CardContent className="flex items-center p-4">
                  ...
                  <Link href="tel:+201552955862" className="flex flex-1 items-center justify-between">
                    <span>01552955862</span>
                    <ExternalLink className="h-4 w-4 opacity-0 transition-opacity group-hover:opacity-100" />
                  </Link>
                </CardContent>
